...
```text
dischem-omni-channel-inventory-orchestrator/
+-- .github/
¦   +-- workflows/
¦   ¦   +-- ci.yml
¦   ¦   +-- tests.yml
...
¦   +-- 04_executive_metrics_validation.ipynb
+-- orchestration/
¦   +-- batch/
¦   ¦   +-- ingest_pos.py
¦   ¦   +-- ingest_sap.py
...
## Best-practice repo setup notes

### What to pin to the top of the GitHub repo
- A strong architecture diagram
- 3 to 5 screenshots of the dashboard
- A concise business problem statement
- Tangible impact metrics
- A clean quick-start section

### What recruiters should understand within 30 seconds
- You can connect business strategy to technical implementation
- You understand modern data platforms end to end
- You can present analytics at executive level
- You can incorporate ML and LLM components in a governed way

### What to build next after this
1. A polished architecture diagram
2. A full `README.md` file in the repo root
3. A `docs/business_case.md` and `docs/architecture/solution_overview.md`
4. A first Streamlit dashboard shell
5. Synthetic datasets and Gold KPIs