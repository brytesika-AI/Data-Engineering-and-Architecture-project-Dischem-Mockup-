...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Ingest clinic scripts raw data into Bronze layer.")
    parser.add_argument("--source", type=Path, default=Path("data/raw/clinic_scripts_raw.csv"))
