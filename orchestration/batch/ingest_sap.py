...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Ingest SAP inventory raw data into Bronze layer.")
    parser.add_argument("--source", type=Path, default=Path("data/raw/sap_inventory_levels_raw.csv"))
...
def main() -> None:
    ...
    result = ingest_dataset(
        dataset="sap_inventory_levels_raw",
